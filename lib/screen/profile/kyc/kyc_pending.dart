...
class KycPendingPhase extends StatefulWidget {
  const KycPendingPhase({super.key});

  @override
  State<KycPendingPhase> createState() => _KycPendingPhaseState();
}

class _KycPendingPhaseState extends State<KycPendingPhase> {
  var height;
  var width;
